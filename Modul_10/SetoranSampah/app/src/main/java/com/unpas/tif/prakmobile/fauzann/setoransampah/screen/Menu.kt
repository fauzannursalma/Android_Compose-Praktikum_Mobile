...
import com.unpas.tif.prakmobile.fauzann.setoransampah.R
...
enum class Menu(
    ...
    PENGELOLAAN_SAMPAH(R.string.pengelolaan_sampah, Icons.Default.List, "pengelolaan-sampah"),
    SETTING(
        R.string.setting, Icons.Default.Settings,
        "setting"
    );
